    ...
    const teams = [
        {
            name: "India",
            suspended: false,
            back: [{ odd: "2.34", vol: "7323" }, { odd: "2.36", vol: "617" }, { odd: "2.38", vol: "24" }],
            lay: [{ odd: "2.4", vol: "450" }, { odd: "2.42", vol: "4449" }, { odd: "2.46", vol: "7115" }]
        },
        {
            name: "Australia",
            suspended: false,
            back: [{ odd: "38", vol: "283" }, { odd: "44", vol: "3190" }, { odd: "46", vol: "798" }],
            lay: [{ odd: "60", vol: "53" }, { odd: "65", vol: "27" }, { odd: "80", vol: "10" }]
        },
        {
            name: "South Africa",
            suspended: false,
            back: [{ odd: "5.6", vol: "1218" }, { odd: "5.7", vol: "529" }, { odd: "5.8", vol: "5788" }],
            lay: [{ odd: "6", vol: "11084" }, { odd: "6.2", vol: "22835" }, { odd: "6.4", vol: "4805" }]
        },
        ...
        <div className='border w-full border-dashed border-[#919eab29] rounded-[4px] overflow-hidden'>
                ...
                <div className='relative flex flex-row items-center h-8 justify-between w-full'>
                    ...
                    <div className='relative flex flex-col items-end max-w-[360px] w-full flex-[5_0_94px]'>
                        ...
                        <div className="flex items-center text-[13px] font-normal leading-[18px] text-[#68CDF9] pt-[1px]">
                            <p>Min: 10</p> &nbsp; <p className="!font-[400] text-[10px]">|</p> &nbsp; <p>Max: 25,000</p>
                        </div>
            ...
            <ul className='relative list-none m-0 p-0 px-1 min-[900px]:px-2 bg-[#191e26]'>
                {teams.map((team, index) => (
                    <li key={index} className="flex flex-col justify-start items-center relative w-full box-border text-left no-underline border-b border-dashed border-[#919eab29] bg-clip-padding hover:bg-[#1C252E] transition-colors ">
                        <div className="flex w-full flex-row flex-1 min-h-[50px] items-center justify-between py-1">
                            ...
                            <div className="font-[500] text-[14px] leading-[1] flex-[1_1_6rem] min-w-0 pr-2">
                                <span className={team.suspended ? "text-white" : "text-white cursor-pointer"}>{team.name}</span>
                            </div>

                            {/* Odds Boxes Container */}
                            <div className='relative flex gap-1 max-w-[360px] h-[35px] w-full flex-[5_0_94px]'>
                                {/* ==== BACK BOXES (BLUE) ==== */}
                                <div className={`flex flex-row-reverse w-1/2 gap-1 overflow-hidden ${
                                    team.suspended ? "bg-black" : " "
                                }`}>
                                    {team.suspended ? (
                                        [1, 2, 3].map((_, i) => (
                                            <div key={`back-susp-${i}`} className={`flex flex-col h-full rounded-[2px] flex-1 min-w-0 bg-[#041117] ${i === 2 ? "max-[464px]:hidden" : ""} ${i === 1 ? "max-[346px]:hidden" : ""}`}></div>
                                        ))
                                    ) : (
                                        team.back?.map((item, i) => (
                                            <div key={`back-act-${i}`} className={`flex flex-col items-center justify-center h-full rounded-[2px] flex-1 min-w-0 cursor-pointer text-black transition-colors ${i === 0 ? "bg-[#0591cf] hover:bg-[#68CDF9]" : "bg-[#0a77a8] hover:bg-[#68CDF9]"} ${i === 2 ? "max-[464px]:hidden" : ""} ${i === 1 ? "max-[346px]:hidden" : ""}`}>
                                                <span className="text-[11px] sm:text-[13px] font-bold leading-[1.1] truncate">{item.odd}</span>
                                                <span className="text-[9px] sm:text-[10px] font-normal leading-[1] truncate">{item.vol}</span>
                                            </div>
                                        ))
                                    )}
                                </div>
                                ...
                                <div className={`flex w-1/2 gap-1 overflow-hidden ${
                                    ...
                                    {team.suspended ? (
                                        [1, 2, 3].map((_, i) => (
                                            <div key={`lay-susp-${i}`} className={`flex flex-col h-full rounded-[2px] flex-1 min-w-0 bg-[#140d0f] ${i === 2 ? "max-[464px]:hidden" : ""} ${i === 1 ? "max-[346px]:hidden" : ""}`}></div>
                                        ))
                                    ) : (
                                        team.lay?.map((item, i) => (
                                            <div key={`lay-act-${i}`} className={`flex flex-col items-center justify-center h-full rounded-[2px] flex-1 min-w-0 cursor-pointer text-black transition-colors ${i === 0 ? "bg-[#d1686d] hover:bg-[#FFA4A7]" : "bg-[#a3555b] hover:bg-[#FFA4A7]"} ${i === 2 ? "max-[464px]:hidden" : ""} ${i === 1 ? "max-[346px]:hidden" : ""}`}>
                                                <span className="text-[11px] sm:text-[13px] font-bold leading-[1.1] truncate">{item.odd}</span>
                                                <span className={`text-[9px] sm:text-[10px] font-normal leading-[1] truncate`}>{item.vol}</span>
                                            </div>
                                        ))
                                ...
                                {team.suspended && (
                                    <div className="absolute inset-0 z-10 flex items-center justify-center pointer-events-none">
                                        <p className="m-0 text-[#FF8C4B] text-[16px] font-[500] leading-[1.5] tracking-wide">SUSPENDED</p>
                                    </div>
                                )}
                            </div>
                        </div>
        ...
        <div className='w-full mx-auto box-border flex flex-auto flex-col pt-2 pb-2'>
                    ...
                    <div className="grow">
                        <div className=" flex flex-wrap gap-2 min-[900px]:gap-4">
                            <span className='h-6 min-w-6 inline-flex justify-center items-center text-sm bg-[#078dee29] rounded-[6px] px-1.5 gap-2.5'>
                                <a href="" className="inline-flex">Home</a>
                            </span>
                            <span className='h-6 min-w-6 inline-flex justify-center items-center text-sm bg-[#078dee29] rounded-[6px] pl-[8px] pr-2 gap-2.5'>
                                <span className='text-[#68CDF9]'><Icon name="play" className='w-5 h-5' /></span>
                                <a href="" className="inline-flex">Cricket</a>
                            </span>
                            <span className='h-6 min-w-6 inline-flex justify-center items-center text-sm bg-[#078dee29] rounded-[6px] pl-[8px] pr-2 gap-2.5'>
                                <span className='text-[#68CDF9]'><Icon name="play" className='w-5 h-5' /></span>
                                <a href="" className="inline-flex">ICC Men's T20 World Cup</a>
                            </span>
                            <span className='h-6 min-w-6 inline-flex justify-center items-center text-sm bg-[#078dee29] rounded-[6px] pl-[8px] pr-2 gap-2.5'>
                                <span className='text-[#68CDF9]'><Icon name="play" className='w-5 h-5' /></span>
                                <a href="" className="inline-flex">ICC Men's T20 World Cup</a>
                ...
                <div className="w-full">
                    ...
                    >
                        ...
                        <button className="inline-flex items-center justify-center relative box-border bg-transparent cursor-pointer select-none align-middle appearance-none font-sans text-center text-inherit text-lg outline-none border-0 m-0 no-underline flex-none rounded-full p-[5px]">
                            ...
                            <div className={`transition-transform duration-300 ${!isBookmakerOpen ? 'rotate-180' : 'rotate-0'}`}>
            ...
            {(activeTab === "ALL" || activeTab === "ODDS") && (
                <div className="w-full">
                    ...
                    >
                        <div className="grow">
                            <span className='font-semibold text-[0.875rem] leading-[1.57143]'>Odds</span>
                        </div>
                        <button className="inline-flex items-center justify-center relative box-border bg-transparent cursor-pointer select-none align-middle appearance-none font-sans text-center text-inherit text-lg outline-none border-0 m-0 no-underline flex-none rounded-full p-[5px]">
                            {/* Icon Rotation Animation */}
                            <div className={`transition-transform duration-300 ${isOddsOpen ? 'rotate-180' : 'rotate-0'}`}>
                                <Icon name="arrowDown" className='w-5 h-5' />
                            </div>
                        </button>
                    </div>
