...
const BottomNavbar = () => {
  ...
  return (
    <div
      className={cn(
        "md:hidden fixed border shadow-[0_8px_32px_rgba(0,0,0,0.2)]! bottom-5 left-1/2 -translate-x-1/2 px-2 py-2 gap-2 w-[85%] flex justify-center items-center rounded-full glass h-15",
        theme === "dark"
