        ...
        <div className="flex w-full flex-col @min-[700]:flex-row">
          ...
          <div className="w-full p-[5px]">
            <div className="flex flex-row whitespace-nowrap items-center max-w-full min-h-[1.125rem] overflow-hidden -mt-1 mr-5 -mb-1 -ml-1 text-[9px] font-bold tracking-[0.7px] uppercase text-[#098DEE]">
              {/* Sport Name */}
              <span
                onClick={() => router.push(`/sport/${event?.eventType?.name}`)}
                className="m-0 [font:inherit] [letter-spacing:inherit] text-(--primary-color) cursor-pointer relative rounded-[8px] py-1 px-0 inline-block cursor-pointer"
              >
                <div className="rounded-1 pl-1 pr-[2px] text-[9px]">{event.eventType?.name}</div>
              </span>

              <span className="h-1 w-1 rounded-full bg-[rgb(99,115,129)] mx-[2px]"></span>

              {/* Competition Name */}
              <span
                onClick={() => router.push(`/sport/${event?.eventType?.name}/${event?.competition?.id}`)}
                className="m-0 [font:inherit] [letter-spacing:inherit] text-(--primary-color) cursor-pointer relative rounded-[8px] py-1 px-0 inline-block"
              >
