...
export const themeOptions = [
  ...
  // 2. Premium VIP Gold (Bohat decent aur luxury look - Best for Casino)
  {
    ...
    bg: {
      light: "#fefce8",
      dark: "radial-gradient(circle at 50% 0%, #422006 0%, #09090b 100%)",
    },
    account: {
      color: "#DEB029",
      bgLight: "#F6E7C2",
  ...
  // 3. Royal Amethyst (Modern aur mysterious deep purple)
  {
    ...
    bg: {
      light: "#faf5ff",
      dark: "radial-gradient(circle at 50% 0%, #2e1065 0%, #09090b 100%)",
    },
    account: {
      color: "#AA5CF3",
      bgLight: "#E6D4FC",
  ...
  // 4. Mint FinTech (Aankhon ko thendak dene wala fresh teal/mint)
  {
    ...
    bg: {
      light: "#f0fdfa",
      dark: "radial-gradient(circle at 50% 0%, #042f2e 0%, #09090b 100%)",
    },
    account: {
      color: "#1EBAA8",
      bgLight: "#CFF3EF",
  ...
  // 5. Velvet Rose (Chubne wala red nahi, bohat soft aur premium ruby/rose)
  {
    ...
    bg: {
      light: "#fff1f2",
      dark: "radial-gradient(circle at 50% 0%, #4c0519 0%, #09090b 100%)",
    },
    account: {
      color: "#EE4767",
      bgLight: "#FCD6DD",
  ...
  // 6. Oceanic Trust (FinTech apps wala deep blue, trust build karta hai)
  {
    ...
    bg: {
      light: "#eff6ff",
      dark: "radial-gradient(circle at 50% 0%, #1e3a8a 0%, #09090b 100%)",
    },
    account: {
      color: "#4384F3",
      bgLight: "#D6E6FE",
  ...
  // 7. Ignite Orange (Sports vibes ke liye energetic aur warm)
  {
    ...
    bg: {
      light: "#fff7ed",
      dark: "radial-gradient(circle at 50% 0%, #431407 0%, #09090b 100%)",
    },
    account: {
      color: "#F37524",
      bgLight: "#FDE3D3",
  ...
  // 8. Neon Matrix (Hacker/Trading style ka sharp neon green glow)
  {
    ...
    bg: {
      light: "#f0fdf4",
      dark: "radial-gradient(circle at 50% 0%, #14532d 0%, #09090b 100%)",
    },
    account: {
      color: "#30C165",
      bgLight: "#D4F5DF",
  ...
  // 9. Cosmic Pink (Bohat trendy aur Gen-Z appealing color)
  {
    ...
    bg: {
      light: "#fdf4ff",
      dark: "radial-gradient(circle at 50% 0%, #4a044e 0%, #09090b 100%)",
    },
    account: {
      color: "#D450E6",
      bgLight: "#0C2F18",
  ...
  // 10. Platinum Sleek (Un users k liye jinhe srf black/grey pasand hai)
  {
    ...
    bg: {
      light: "#f8fafc",
      dark: "radial-gradient(circle at 50% 0%, #1e293b 0%, #09090b 100%)",
    },
    account: {
      color: "#98A5B6",
      bgLight: "#2F0A34",
...
export const applyThemeColors = (
  ...
  if (selectedTheme) {
    ...
    const accountTab = selectedTheme.account;
    ...
    root.style.setProperty(
      "--account-tab-bg",
      currentMode === "dark" ? accountTab.bgDark : accountTab.bgLight,
    );
...
export default function ColorThemeProvider({
  ...
  useEffect(() => {
    const savedTheme =
      localStorage.getItem("app-color-theme") || "default-blue";
