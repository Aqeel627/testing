...
const exclusionData = [
  ...
  { text: "If you feel you are at risk of developing a gambling problem or believe you currently have a gambling problem, please consider using Self-Exclusion which prevents you gambling with 100Exch for a specified period of 3 months, 6 months, 1 year, 2 years, 3 years, 4 years, 5 years or permanently." },
  ...
  { isHeading: true, isCenter: false, text: "What happens when you self-exclude?" },
  { text: "During a period of Self-Exclusion you will not be able to use your account for betting, although you will still be able to login and withdraw any remaining balance. It will not be possible to re-open your account for any reason, and 100Exch will do all it can to detect and close any new accounts you may open." },
  
  // Sub-heading (Left aligned)
  { isHeading: true, isCenter: false, text: "Next steps" },
  { text: "Whilst we will remove you from our marketing databases, we also suggest that you remove 100Exch from your notifications and delete/uninstall all 100Exch apps, downloads and social media links. You may also wish to consider installing software that blocks access to gambling websites, click here for more information." },
  ...
  { text: "Should you opt to self-exclude from 100Exch, we strongly recommend that you seek exclusion from all other gambling operators you have an account with." },
