    ...
    <>
      ...
      <div className="w-full mx-auto flex flex-col flex-grow scroll-mt-[40px]">
        <div className="space-y-3 mt-9">
          <p className="text-center mb-3 text-[12pt] font-sans font-bold underline">KNOW YOUR CUSTOMER POLICY</p>
          ...
          <p className="mb-3 text-[12pt] font-sans font-bold underline">What documents do I need to provide?</p>
          ...
          <p className="mb-3 text-[12pt] font-sans font-bold">Proof of Address</p>
          ...
          <p className="mb-3 text-[12pt] font-sans font-bold">When do I need to provide these documents?</p>
          ...
          <p className="mb-3 text-[12pt] font-sans font-bold">How can I Email you these documents?</p>

          <p className="mb-3 text-[12pt] font-sans">
            Please scan your documents, or take a high quality digital camera picture, save the images as jpegs, then email us using our official email.
          </p>

          <p className="mb-3 text-[12pt] font-sans font-bold">How do I know my documents are safe with you?</p>
          ...
          <p className="mb-3 text-[12pt] font-sans">
            We’d like to thank you for your cooperation in helping us make BetPro.com a safer place to play. As always, if you have any questions about this policy, or anything else, don’t hesitate to contact us using the contact us links on this page
          </p>
        </div>
