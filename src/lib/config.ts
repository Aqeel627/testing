...
export const CONFIG = {
  ...
  getbookieFancyDataURL: BASE_URL + "/api/exchange/markets/getMarketsEventList", // =---=  done 
  ...
  casinoInternational: BASE_URL + '/api/exchange/navigations/internationalCasinoList',// done
  casinoInternationalTime: 1440,

  sportTournamentsList: BASE_URL + '/api/exchange/tournaments/sportTournamentsList',//  =---= not Done Yet
  sportTournamentsListTime: 1440,
  tournamentEventsList: BASE_URL + '/api/exchange/events/tournamentEventsList',//  =---= not Done Yet
  ...
  getSponserDetailsURL: BASE_URL + '/v1/exchange/sponsor/sponsorshipsDetails',// =---= not Done Yet
  ...
  uploadTransactionImageURL: BASE_URL + "/v1/exchange/users/uploadPaymentDetails",
